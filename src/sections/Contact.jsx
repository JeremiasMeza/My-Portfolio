    ...
    return (
        <div className='mx-auto w-full min-h-[50vh] px-4 sm:px-6 lg:px-8' id='contact'>
            ...
            >
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: 0.1 }}
                className='text-4xl sm:text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-sky-500 '>
                    Contactame
                </motion.h1>
                ...
                <motion.p
                    ...
                    Si tienes alguna pregunta o simplemente quieres saludar, no dudes en enviarme un mensaje.
                    <br />
                    </motion.p>
